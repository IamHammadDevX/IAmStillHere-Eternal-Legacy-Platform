...
<head>
  ...
  <link rel="stylesheet" href="css/style.css?v=2026082005" />
</head>
          ...
          <div class="tab-pane fade" id="autobiography-tab">
            <div class="card mb-4">
              <div class="card-body">
                ...
                <p class="ai-disclaimer mb-4">This AI-generated response is based on stored memories and profile information, but it may not always be accurate. AI can make mistakes or misrepresent details — please verify important information independently.</p>
              ...
              <div class="card-body">
                ...
                <div class="collapse show" id="personalized-message-form-wrap">
                  <form id="personalized-message-form" class="row g-2 mb-3">
                    ...
                    <div class="col-12"><label class="form-label small">Draft message</label><textarea id="pm-message" class="form-control" rows="6" placeholder="Generate a draft first, then edit before scheduling."></textarea><p class="ai-disclaimer mt-2 mb-0">This AI-generated response is based on stored memories and profile information, but it may not always be accurate. AI can make mistakes or misrepresent details — please verify important information independently.</p></div>

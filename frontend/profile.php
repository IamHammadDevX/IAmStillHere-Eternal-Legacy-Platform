...
<body>
    ...
    <div id="cover-section" class="position-relative" style="height: 300px; background: linear-gradient(135deg, #9b59b6 0%, #3498db 100%);">
        ...
        <div class="position-absolute bottom-0 start-0 w-100 p-4" style="background: linear-gradient(to top, rgba(0,0,0,0.7), transparent);">
            <div class="container">
                <div class="d-flex align-items-end">
                    <img id="profile-image" src="/frontend/images/default-profile.png" class="profile-photo" alt="Profile">
                    <div class="ms-3 text-white">
                        <h2 id="profile-name">Loading...</h2>
                        <p class="mb-0" id="profile-dates"></p>
                    </div>
                    <button id="edit-profile-btn" class="btn btn-light ms-auto mb-3" style="display: none;" data-bs-toggle="modal" data-bs-target="#editProfileModal">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <button id="memorial-settings-btn" class="btn btn-primary w-100" style="display: none;" data-bs-toggle="modal" data-bs-target="#memorialSettingsModal">
            ...
            <div class="col-md-8">
                <ul class="nav nav-tabs mb-4" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#timeline-tab">Timeline</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#memories-tab">Memories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tributes-tab">Tributes</a>
                    </li>
                </ul>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <form id="tributeForm">
                                        ...
                                        <div class="mb-3">
                                            <textarea class="form-control" id="tribute-message" rows="4" placeholder="Share your memories and condolences..." required></textarea>
                                        </div>
                ...
                <div class="modal-body">
                    <form id="memorialSettingsForm">
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i> Configure how your memorial page will appear after you pass away.
                        </div>
                        <div class="mb-3">
                            ...
                            <small class="text-muted">This determines if your profile appears in the memorial listings.</small>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Date of Passing (if applicable)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="tribute-permission-input">
                                ...
                                <option value="none">No one (tributes disabled)</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary">Save Memorial Settings</button>
                    </form>
                </div>
            </div>
        </div>

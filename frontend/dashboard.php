...
<body class="dashboard-page app-page">
 ...
 <div class="card mb-3 vault-shell"><div class="card-body">
  ...
  <div class="row g-3"><div class="col-12"><div class="border rounded p-3 mb-3"><div class="d-flex justify-content-between align-items-center mb-2"><div><h6 class="mb-0">Documents</h6><div class="small text-muted">Upload a document to your secure vault.</div></div></div><form id="vault-upload-form" class="row g-2"><div class="col-md-5"><input id="vault-file" type="file" class="form-control form-control-sm" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.rtf,.odt,.jpg,.jpeg,.png" required></div><div class="col-md-4"><button class="btn btn-primary w-100" type="submit">Upload Document</button></div></form></div><div id="vault-document-list" class="row g-3"></div></div></div>

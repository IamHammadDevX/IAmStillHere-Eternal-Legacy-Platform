...
<head>
    ...
    <link rel="stylesheet" href="css/style.css?v=2026081608">
</head>
...
<body class="dashboard-page app-page">
        ...
        <div class="row dashboard-feature-grid mb-4">
            ...
            <div class="col-md-3 mb-3">
                <a id="dashboard-tributes-link" class="dashboard-feature-link" href="profile.php#tributes-tab" aria-label="View all tributes">
                    <div class="card text-center h-100"><div class="card-body"><i class="bi bi-people display-4 text-info"></i><h5 class="mt-2">Tributes</h5><p class="mb-0" id="tribute-count">0</p><span class="btn btn-sm btn-outline-info mt-2">View all tributes</span></div></div>
                </a>
            </div>
        </div>
 ...
 <div class="card mb-3 vault-shell"><div class="card-body">
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
   ...
   <div class="d-flex gap-2"><button class="btn btn-outline-primary" id="vault-refresh-btn" type="button">Refresh</button><button id="vault-upload-trigger" class="btn btn-primary" type="button">Upload Document</button></div>
  </div>
  ...
  <div class="row g-3"><div class="col-lg-4"><div class="border rounded p-3 h-100"><div class="d-flex justify-content-between align-items-center mb-2"><h6 class="mb-0">Folders</h6><button id="vault-folder-create" class="btn btn-sm btn-outline-primary" type="button">+ Folder</button></div><div class="input-group input-group-sm mb-3"><input id="vault-folder-name" class="form-control" placeholder="New folder name" aria-label="New folder name"><button class="btn btn-outline-secondary" type="button" onclick="document.getElementById('vault-folder-create')?.click()">Create</button></div><div id="vault-folder-list" class="list-group small"></div></div></div>
   <div class="col-lg-8"><div class="border rounded p-3 mb-3"><div class="d-flex justify-content-between align-items-center mb-2"><div><h6 class="mb-0">Documents</h6><div class="small text-muted">Upload into the folder currently open.</div></div></div><form id="vault-upload-form" class="row g-2"><div class="col-md-4"><input id="vault-display-name" class="form-control form-control-sm" placeholder="Document name (optional)"></div><div class="col-md-5"><input id="vault-file" type="file" class="form-control form-control-sm" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.rtf,.odt,.jpg,.jpeg,.png" required></div><div class="col-md-3"><button class="btn btn-primary w-100" type="submit">Upload Document</button></div></form></div><div id="vault-document-list" class="row g-3"></div></div></div>
...
<div class="modal fade" id="editFolderModal" tabindex="-1"><div class="modal-dialog modal-dialog-scrollable"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Edit folder</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body"><form id="editFolderForm"><input type="hidden" id="edit-folder-id"><label class="form-label">Name</label><input id="edit-folder-name" class="form-control mb-2" maxlength="150" required><label class="form-label">Description</label><textarea id="edit-folder-description" class="form-control mb-2"></textarea><label class="form-label">Parent folder</label><select id="edit-folder-parent" class="form-select mb-3"><option value="0">No parent</option></select><div id="edit-folder-privacy"></div><div id="edit-folder-error" class="small text-danger mt-2"></div></form></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" form="editFolderForm" id="edit-folder-save" class="btn btn-primary">Save changes</button></div></div></div></div>
    <script src="js/privacy.js"></script><script src="js/dashboard.js?v=2026081601"></script>
</body>

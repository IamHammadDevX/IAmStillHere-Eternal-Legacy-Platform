...
function journeys_format_item(PDO $db, array $item): array { return ['id'=>(int)$item['id'],'item_type'=>$item['item_type'],'source_id'=>$item['source_id']? (int)$item['source_id']:null,'title'=>$item['title'],'description'=>$item['description'],'item_date'=>$item['item_date'],'status'=>$item['status'],'contributor_id'=>(int)$item['contributor_id'],'contributor_name'=>$item['contributor_name']??'Unknown']; }
?>

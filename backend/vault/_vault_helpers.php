...
function vault_derived_key(int $owner): string { $secret=(string)getenv('SESSION_SECRET'); if(strlen($secret)<32) throw new RuntimeException('Vault encryption secret is not configured.'); return hash_hmac('sha256','vault-owner-'.$owner,$secret,true); }

...
try {
    ...
    $stmt = $conn->prepare("SELECT t.* FROM tributes t WHERE t.memorial_user_id = :memorial_user_id AND t.status = 'active' AND $approval_condition ORDER BY t.created_at DESC");
